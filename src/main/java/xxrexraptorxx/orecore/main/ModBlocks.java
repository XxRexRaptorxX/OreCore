...
public class ModBlocks {
	...
	public static Block compressedAluminiumOre;
	public static Block compressedAmethystOre;
	public static Block compressedCopperOre;
	public static Block compressedIridiumOre;
	public static Block compressedLeadOre;
	public static Block compressedPlatinumOre;
	public static Block compressedQuartzOre;
	public static Block compressedRubyOre;
	public static Block compressedSapphireOre;
	public static Block compressedSilverOre;
	public static Block compressedTinOre;
	public static Block compressedUraniumOre;
	...
	public static Block fossilStand6;
		...
		public void init() {
			...
			compressedAluminiumOre = new BlockCompressedAluminiumOre();
			compressedAmethystOre = new BlockCompressedAmethystOre();
			compressedCopperOre = new BlockCompressedCopperOre();
			compressedIridiumOre = new BlockCompressedIridiumOre();
			compressedLeadOre = new BlockCompressedLeadOre();
			compressedPlatinumOre = new BlockCompressedPlatinumOre();
			compressedQuartzOre = new BlockCompressedQuartzOre();
			compressedRubyOre = new BlockCompressedRubyOre();
			compressedSapphireOre = new BlockCompressedSapphireOre();
			compressedSilverOre = new BlockCompressedSilverOre();
			compressedTinOre = new BlockCompressedTinOre();
			compressedUraniumOre = new BlockCompressedUraniumOre();
			...
			netherPlatinOre = new BlockNetherPlatinumOre();
			...
			endPlatinOre = new BlockEndPlatinumOre();
			...
			NameUtils.setNames(compressedAluminiumOre, "compressed_aluminium_ore");
			NameUtils.setNames(compressedAmethystOre, "compressed_amethyst_ore");
			NameUtils.setNames(compressedCopperOre, "compressed_copper_ore");
			NameUtils.setNames(compressedIridiumOre, "compressed_iridium_ore");
			NameUtils.setNames(compressedLeadOre, "compressed_lead_ore");
			NameUtils.setNames(compressedPlatinumOre, "compressed_platinum_ore");
			NameUtils.setNames(compressedQuartzOre, "compressed_quartz_ore");
			NameUtils.setNames(compressedRubyOre, "compressed_ruby_ore");
			NameUtils.setNames(compressedSapphireOre, "compressed_sapphire_ore");
			NameUtils.setNames(compressedSilverOre, "compressed_silver_ore");
			NameUtils.setNames(compressedTinOre, "compressed_tin_ore");
			NameUtils.setNames(compressedUraniumOre, "compressed_uranium_ore");
			...
			NameUtils.setNames(aluminiumOre, "aluminium_ore");
			NameUtils.setNames(amethystOre, "amethyst_ore");
			NameUtils.setNames(copperOre, "copper_ore");
			NameUtils.setNames(iridiumOre, "iridium_ore");
			NameUtils.setNames(leadOre, "lead_ore");
			NameUtils.setNames(platinumOre, "platinum_ore");
			NameUtils.setNames(rubyOre, "ruby_ore");
			NameUtils.setNames(sapphireOre, "sapphire_ore");
			NameUtils.setNames(silverOre, "silver_ore");
			NameUtils.setNames(tinOre, "tin_ore");
			NameUtils.setNames(uraniumOre, "uranium_ore");
			NameUtils.setNames(quartzOre, "quartz_ore");
		...
		public void register() {
			...
			registerBlock(compressedAluminiumOre);
			registerBlock(compressedAmethystOre);
			registerBlock(compressedCopperOre);
			registerBlock(compressedIridiumOre);
			registerBlock(compressedLeadOre);
			registerBlock(compressedPlatinumOre);
			registerBlock(compressedQuartzOre);
			registerBlock(compressedRubyOre);
			registerBlock(compressedSapphireOre);
			registerBlock(compressedSilverOre);
			registerBlock(compressedTinOre);
			registerBlock(compressedUraniumOre);
